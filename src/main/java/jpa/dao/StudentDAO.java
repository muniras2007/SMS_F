package jpa.dao; //data access object
...
// for a Student with that email and returns a Student Object.
    ...
    //This method takes two parameters: the first one is the user email and the second one
    // is the password from the user input. Return whether or not a student was found
